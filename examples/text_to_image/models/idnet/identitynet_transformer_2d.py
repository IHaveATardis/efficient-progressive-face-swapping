...
class Transformer2DModelOutput(BaseOutput):
    ...
    idnet_residuals: Tuple[torch.FloatTensor, ...]
    ...
    def forward(
        ...
        for block in self.transformer_blocks:
            if torch.is_grad_enabled() and self.gradient_checkpointing:
                ...
                hidden_states, idnet_output = block(
                    hidden_states,
        ...
        if not return_dict:
            return (output, idnet_residuals)

        return Transformer2DModelOutput(sample=output, idnet_residuals=idnet_residuals)
