...
class UNet2DConditionModel(
    ...
    def forward(
        ...
        idnet_residuals: Optional[List[Tuple[Tuple[torch.FloatTensor, ...]]]] = None, 
        ...
        for i, downsample_block in enumerate(self.down_blocks):
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                ...
                sample, res_samples = downsample_block(
                    ...
                    idnet_residuals=idnet_residuals[0][i],
                    **additional_residuals,
                )
            else:
        ...
        if self.mid_block is not None:
            if hasattr(self.mid_block, "has_cross_attention") and self.mid_block.has_cross_attention:
                sample = self.mid_block(
                    ...
                    cross_attention_kwargs=cross_attention_kwargs,
                    encoder_attention_mask=encoder_attention_mask,
                    idnet_residuals=idnet_residuals[1][0] if idnet_residuals is not None else None,  
                )
            else:
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            if hasattr(upsample_block, "has_cross_attention") and upsample_block.has_cross_attention:
                sample = upsample_block(
                    ...
                    attention_mask=attention_mask,
                    encoder_attention_mask=encoder_attention_mask,
                    idnet_residuals=idnet_residuals[2][j] if idnet_residuals is not None else None,
                )
                j += 1
            else:
                sample = upsample_block(
